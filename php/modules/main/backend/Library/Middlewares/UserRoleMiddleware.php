...
class UserRoleMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        if (isset($moduleConfig['paused']) && !$moduleConfig["paused"] && $this->routePermission != "" && $currentUserInfo->get("role_id") != EnumUserRoleType::COPYWRITER_SPECIALIST->value) {//用户权限模块启用，定义权限的路由 进行权限验证
